...
This Salon Application is a web app that allows customers to create accounts, log in, and book appointments.

## Features 

### User accounts
- Users can sign up or log in to their accounts securely 
- Users can book an appointment while logged into an account using local storage

### Technologies Used 
- Frontend: HTML, CSS, Javascript
- Backend: Node.js, Express

## ERD Diagram & Relations Diagram
